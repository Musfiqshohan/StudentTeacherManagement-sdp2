...
def student_main():
    ...
    if info['period'] == 'Elective course':
        info['message'] = "You can take classes"
    else:
        info['message'] = "You can view the selected course"
    if not avg_grade or not avg_grade[0]:
        info['avg_grade'] = 0
    else:
        info['avg_grade'] = avg_grade[0]
...
def teacher_tea_cloud():
    ...
    for tea in teas:
        ...
        tags = tags + link
    tags = tags + "</tags>"
    return render_template('tags_cloud.html', title='Popular teacher', tags=tags)
